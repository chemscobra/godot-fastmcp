...
#https://github.com/Coding-Solo/godot-mcp/blob/main/src/scripts/godot_operations.gd
#Credits to https://github.com/Coding-Solo
extends SceneTree
...
func _init():
	...
	# (script_index + 1 is the script path itself)
	...
	var params = null
	# Remove trailing whitespace from params_json
	params_json = params_json.strip_edges()
	if error == OK:
